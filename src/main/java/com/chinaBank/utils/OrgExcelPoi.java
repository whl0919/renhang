...
public class OrgExcelPoi {
    ...
    // 构造方法，传入要导出的数据
    public OrgExcelPoi(String title, String[] rowName, List<Object[]> dataList) {
     ...
     * 导出数据
     */
    public void export(OutputStream out,HSSFWorkbook workbook) throws Exception {
    	int x = 0;
    	int y = 0;
    	String data = "";
        try {
